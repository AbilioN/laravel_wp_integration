...
class CorcelAuthController extends Controller
{
    /**
...
";
    ...
    public function profile()
    {
        ...
        if (!$user) {
            return redirect('/login')->withErrors(['general' => 'Usuário não encontrado']);
        }
